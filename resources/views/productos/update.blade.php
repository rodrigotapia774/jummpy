...
@section('content')
    ...
    <div class="pb-12 pt-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h3 class="text-1xl sm:text-2xl lg:text-3xl leading-none font-extrabold tracking-tight text-gray-900 mb-4 sm:mb-6">Editar producto <a href="{{ url('/productos') }}" class="btn btn-orange float-right"><i class="fas fa-long-arrow-alt-left"></i> Volver a productos</a></h3>
        </div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-3">
                <div clas="row">
                    <form method="POST" class="row needs-validation" action="{{ Route('productos/update') }}" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="cantidad" name="cantidad" class="form-control allNumer" autocomplete="off" value="{{$datos->total}}" required>
                                        <div class="invalid-feedback">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="oferta" name="oferta" class="form-control allNumer" value="{{$datos->sale}}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-3">
