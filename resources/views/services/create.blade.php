...
@section('content')
    ...
    <div class="pb-12 pt-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h3 class="text-1xl sm:text-2xl lg:text-3xl leading-none font-extrabold tracking-tight text-gray-900 mb-4 sm:mb-6">Nueva licitación <a href="{{ url('/servicios') }}" class="btn btn-orange float-right"><i class="fas fa-long-arrow-alt-left"></i> Volver a licitaciones</a></h3>
        </div>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-3">
                <div clas="row">
                    <form method="POST" class="row needs-validation" action="{{ Route('servicios/create') }}" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" id="cierre" name="cierre" class="form-control" autocomplete="off" required>
                                        <div class="invalid-feedback">
                                            Agregue un valor valido.
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" id="entrega" name="entrega" class="form-control" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-3">
